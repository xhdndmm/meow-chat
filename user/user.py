...
class MainWindow(QMainWindow):
    ...
    def login_to_server(self):
        ...
        try:
            ...
            response = read_message(self.client_socket)
            resp = json.loads(base64.b64decode(response).decode("utf-8"))
            ...
            if resp.get("message"):
                QMessageBox.information(self, "提示", resp["message"])
    ...
    def load_history(self):
        ...
        try:
            ...
            QMessageBox.warning(self, "错误", "加载聊天记录失败")
